    ...
    <StyledBox>
      <Container>
        ...
        >
          <Grid2 size={6}>
            <Typography variant="body1" gutterBottom>
              ООО &quotСервисная Торговая Компания&quot — это лидер в области
              логистики, предлагающий инновационные решения для доставки и
              хранения грузов.
            </Typography>
            <Typography variant="body1" gutterBottom>
        ...
        <Grid2 container justifyContent="space-between">
          ...
          <Grid2 size={6}>
            <Typography variant="body1" gutterBottom>
              В ООО &quotСервисная Торговая Компания&quot мы понимаем, что
              логистика — это не просто транспортировка, а важный элемент
              успешного бизнеса. Мы предлагаем полный спектр услуг: от
              грузоперевозок до складирования и таможенного оформления.
            </Typography>
            <Typography variant="body1" gutterBottom>
